...
namespace BadOrder.Library.Models.Services
{
    public static class ResultExtensions
    {
        public static IActionResult AsActionResult(this OrderResult result) => result switch
        {
            ...
            OrderNotFound order => new NotFoundObjectResult(order.Result),
            OrderUnauthorized order => new UnauthorizedObjectResult(order.Result),
        ...
        public static IActionResult AsActionResult(this ItemResult result, string actionName = null) => result switch
        {
            ...
            ItemNotFound item => new NotFoundObjectResult(item.Result),
        ...
        public static IActionResult AsActionResult(this UserResult result, string actionName = null) => result switch
        {
            ...
            EmailInUse request => new ConflictObjectResult(request.Result),
            InvalidRole request => new BadRequestObjectResult(request.Result),
            AuthenticateFailur request => new UnauthorizedObjectResult(request.Result),
            UserNotFound request => new BadRequestObjectResult(request.Result),
